...
def scrape_all_shops():
    bilka_scraped = bilka.search_product_list(1,random.randint(10, 30))
    proshop_scraped = proshop.search_product_list(1,random.randint(10, 30))
    elgiganten_scraped = elgiganten.search_product_list(1,random.randint(10, 30))
    fonix_scraped = fonix.search_product_list(1,random.randint(10, 30))
